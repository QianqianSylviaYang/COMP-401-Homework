...
public interface Belt {
	 ...
	 */	
	public void rotate();
	//accept BeltObserver as parameter and add new observer to the observer list
	void addBeltObserver(BeltObserver o);
	//accept BeltObserver as parameter and remove observer from the observer list
	void removeBeltObserver(BeltObserver o);
	/*
	 * Accept Customer and int as parameter
	 * add new customer to the position
	 */
	void registerCustomerAtPosition(Customer c, int position);
	/*
	 * Accept int as parameter
	 * remove customer to the position
	 */
	Customer unregisterCustomerAtPosition(int position);
